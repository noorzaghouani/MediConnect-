 ...
 */
final class Version20260122014446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD allergies LONGTEXT DEFAULT NULL, ADD tension VARCHAR(20) DEFAULT NULL, ADD temperature NUMERIC(4, 1) DEFAULT NULL, ADD frequence_cardiaque INT DEFAULT NULL, CHANGE traitement symptomes LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD traitement LONGTEXT DEFAULT NULL, DROP symptomes, DROP allergies, DROP tension, DROP temperature, DROP frequence_cardiaque');
