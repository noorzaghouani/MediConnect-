 ...
 */
final class Version20251225181732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation DROP rendez_vous_id, DROP traitement, CHANGE symptomes symptomes LONGTEXT DEFAULT NULL, CHANGE allergies allergies LONGTEXT DEFAULT NULL, CHANGE tension tension VARCHAR(20) DEFAULT NULL, CHANGE temperature temperature NUMERIC(4, 1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD consultation_id INT DEFAULT NULL, DROP date, CHANGE updated_at updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_65E8AA0A62FF6CDF ON rendez_vous (consultation_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD rendez_vous_id INT DEFAULT NULL, ADD traitement LONGTEXT DEFAULT NULL, CHANGE symptomes symptomes TEXT DEFAULT NULL, CHANGE allergies allergies TEXT DEFAULT NULL, CHANGE tension tension VARCHAR(20) DEFAULT \'NULL\', CHANGE temperature temperature NUMERIC(4, 1) DEFAULT \'NULL\'');
        ...
        $this->addSql('DROP INDEX UNIQ_65E8AA0A62FF6CDF ON rendez_vous');
        $this->addSql('ALTER TABLE rendez_vous ADD date DATETIME NOT NULL, DROP consultation_id, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
